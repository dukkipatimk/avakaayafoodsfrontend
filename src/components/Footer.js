        ...
        <div className="container footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-countries">
              {[
                { flag: '🇮🇳', name: 'India', note: 'Free above ₹999' },
                { flag: '🇺🇸', name: 'USA', note: 'From $25' },
                { flag: '🇬🇧', name: 'United Kingdom', note: 'From £20' },
                { flag: '🇸🇬', name: 'Singapore', note: 'From S$18' },
                { flag: '🇦🇺', name: 'Australia', note: 'From A$28' },
                { flag: '🇲🇾', name: 'Malaysia', note: 'From RM45' },
              ].map(c => (
