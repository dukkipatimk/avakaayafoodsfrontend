        ...
        <div className="container footer-grid">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://wa.me/919115595959" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links">
              ...
              <li><a href="https://wa.me/919115595959">WhatsApp Support</a></li>
            </ul>
          </div>

          {/* Shipping Countries */}
          <div className="footer-col">
            <h4 className="footer-heading">We Ship To</h4>
            <div className="footer-countries">
              {[
                { flag: '🇮🇳', name: 'India', note: '1–2 days' },
                { flag: '🇺🇸', name: 'USA', note: '3–7 days' },
                { flag: '🇬🇧', name: 'United Kingdom', note: '3–7 days' },
                { flag: '🇸🇬', name: 'Singapore', note: '3–7 days' },
                { flag: '🇦🇺', name: 'Australia', note: '3–7 days' },
                { flag: '🇲🇾', name: 'Malaysia', note: '3–7 days' },
              ].map(c => (
                <div key={c.name} className="footer-country-item">
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-inner">
          <p className="footer-copy">
            © {new Date().getFullYear()} Avakaaya Foods. All rights reserved. Made with ❤️ in Hyderabad.
          </p>
          <div className="footer-payment-icons">
            ...
            <span className="payment-badge">ICICI Bank</span>
          </div>
        </div>
      </div>
    </footer>
